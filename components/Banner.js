...
export default function Banner() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-[58%_42%] min-h-screen">
      <div className="bg-white flex items-start justify-center">
        <div className="w-full flex justify-center">
          <div className="max-w-[1320px] w-full px-4 pt-28 pb-10 text-center md:text-left">
      ...
      <div className="relative bg-[#00D5AE] w-full min-h-[400px] md:min-h-full overflow-hidden rounded-none md:rounded-bl-[100px]">
        <div className="absolute top-15 left-14 w-14 h-14 bg-white rounded-lg flex items-center justify-center shadow rotate-[-10deg]">
          <FaSearch className="text-[#00D5AE] text-2xl" />
        </div>
        <div className="absolute bottom-25 left-8 w-14 h-14 bg-white rounded-lg flex items-center justify-center shadow rotate-[-10deg]">
          <BsShieldShaded className="text-[#00D5AE] text-2xl" />
        </div>
        <div className="absolute bottom-60 right-16 w-14 h-14 bg-white rounded-lg flex items-center justify-center shadow rotate-[10deg]">
