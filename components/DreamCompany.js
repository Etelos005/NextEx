export default function DreamCompany() {
  return (
    <section className="py-12 md:py-20 px-4 bg-white">
      <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 md:grid-cols-12 items-center gap-8 min-h-[450px]">
        ...
        {/* Text Section */}
        <div className="md:col-span-6 flex flex-col justify-center gap-4 text-center md:text-left items-center md:items-start md:-ml-[120px]">
