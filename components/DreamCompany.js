export default function DreamCompany() {
  return (
    <section className="py-20 px-6 bg-white">
      <div className="container mx-auto px-6 grid grid-cols-3 md:grid-cols-12 items-center gap-0">
        ...
        <div className="md:col-span-6 -ml-30 flex flex-col gap-4 text-center md:text-left items-center md:items-start">
